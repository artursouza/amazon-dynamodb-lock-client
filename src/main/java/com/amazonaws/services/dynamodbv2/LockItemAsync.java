 ...
 * {@link AmazonDynamoDBLockClientAsync#withLockAsync} to release the lock.
 */
public class LockItemAsync {
     ...
     */
    LockItemAsync(final String partitionKey, final Optional<String> sortKey,
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof LockItemAsync)) {
            return false;
        }
        final LockItemAsync o = (LockItemAsync) other;
    ...
    public String toString() {
        ...
        return String.format(
                "LockItemAsync{Partition Key=%s, Sort Key=%s, Owner Name=%s, Lookup Time=%d, "
